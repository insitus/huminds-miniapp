        ...
        >
            <CardBody>
                <div className="grid grid-cols-4 items-center p-1">
                    ...
                    <div className="flex flex-col col-span-3 items-start justify-start mr-3">
                        <h2 className="text-smal font-medium" style={{ color: 'orange' }}>{upperTitle}</h2>
                        {/* dark: <h1 className="text-large font-semibold mt-0" style={{ color: 'rgba(255, 255, 255, 0.87)' }}>{title}</h1> */}
                        <h1 className="text-medium font-medium mr-1" style={{ color: 'rgba(0, 0, 0, 0.7)' }}>{title}</h1>
